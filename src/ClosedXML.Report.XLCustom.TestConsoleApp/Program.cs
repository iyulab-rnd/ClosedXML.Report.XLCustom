...
namespace ClosedXML.Report.XLCustom.TestConsoleApp
{
    internal class Program
    {
        ...
        static void GenerateReport(string templatePath, string outputPath, object data)
        {
            ...
            XLCustomTemplate.EnableDetailedLogging = true;
            ...
            template.DebugFunctions();
            template.LogDiagnostics();
            ...
            // After generation, diagnose any remaining issues
            template.DiagnoseTemplateIssues();
